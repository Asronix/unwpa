...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/news and updates/css/styles.css" />
    <link rel="stylesheet" href="assets/news and updates/css/news-and-updates.css" />
  ...
  <div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="d-flex flex-column bd-highlight  mb-3">
          <div class="p-2 bd-highlight">
            <div class="activities-post">
              <img src="assets\Tokyo_news 1.png" alt="" class="img-fluid">
          ...
          <div class="p-2 bd-highlight">
            <div class="activities-post">
              <img src="assets\bangladesh_news1 1.png" alt="" class="img-fluid">
              <div class=" d-flex align-items-end ">
          ...
          <div class="p-2 bd-highlight">
            <div class="activities-post">
              <img src="assets\bangladesh_news 2.png" alt="" class="img-fluid">
              <div class=" d-flex align-items-end ">
          ...
          <div class="p-2 bd-highlight">
            <div class="activities-post">
              <img src="assets\Thailand_SmartChild 1.png" alt="" class="img-fluid">
              <div class=" d-flex align-items-end ">
      ...
      <div class="col-sm-7">
        <img src="assets\japan_news 1.png" alt="" class="img-fluid h-100 w-100">
...
<div class="mobile-and-tablet-view">
  <div class="container">
    ...
    <div class="row mb-3">
      <div class="col-sm-6">
        <div class="card p-3" style="width: 18rem;">
          <img src="assets\japan_news 4.png" class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <div class="col-sm-6">
        <div class="card p-3" style="width: 18rem;">
          <img src="assets\News 6.png" class="card-img-top" alt="...">
          <div class="card-body">
    ...
    <div class="row mb-3">
      <div class="col-sm-6">
        <div class="card p-3" style="width: 18rem;">
          <img src="assets\Tokyo_news 2.png" class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <div class="col-sm-6">
        <div class="card p-3" style="width: 18rem;">
          <img src="assets\bangladesh_news1 2.png" class="card-img-top" alt="...">
          <div class="card-body">
